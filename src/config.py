...
TICK_COLOR  = PLOT_STYLE["text_color"]
...
# Flat convenience maps used by visualization.py
CONST_COLORS_MAP = {k: v["color"] for k, v in CONST_CONFIG.items()}
CONST_NAMES      = {k: v["name"]  for k, v in CONST_CONFIG.items()}
